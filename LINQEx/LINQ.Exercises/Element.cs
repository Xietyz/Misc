...
namespace LINQ.Exercises
{
    ...
    public class Element
    {
        ...
        {
            int result = 0;
            if (TestData.Numbers.Max() > 10)
            {
                result = TestData.Numbers.First();
            }
        ...
        {
            int result = 0;
            if (TestData.Numbers.Min() < -1234)
            {
                result = TestData.Numbers.Last();
            }
        ...
        {
            string result = TestData.Animals.Last(x => x == "elephant");
        ...
        {
            string result = TestData.Animals.First(x => x.Length == 4);
        ...
        {
            string result = TestData.Animals.First(x => x.Substring(0, 1).Equals("s"));
        ...
        {
            string result = null;
            if (TestData.Animals.Count(s => s.Length == 3) != 0)
            {
                TestData.Animals.Last(s => s.Length == 3);
            }
        ...
        {
            TestData.Person result = TestData.People.First(x => x.Born.Year > 2000);
        ...
        {
            TestData.Person result = null;
            if (TestData.People.Count(x => x.FirstName.Substring(0, 1).Equals("J")) == 0)
            {
                result = TestData.People.Last(x => x.FirstName.Substring(0, 1).Equals("J"));
            }
            Assert.AreEqual(null, result);
        }
    }
