...
namespace LINQ.Exercises
{
    ...
    public class OrderBy
    {
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderBy(x => x);
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderBy(x => x.Substring(1, 2));
        ...
        {
            IEnumerable<string> result = TestData.OrderByWordsExtended.OrderByDescending(x => x);
        ...
        {
            IEnumerable<string> result = TestData.OrderByWords.OrderBy(x => x.Length);
        ...
        //public class CaseIgnoreComp : IComparer
        //{
        ...
        {
            IEnumerable<string> result = SpecialOrderFunction(TestData.OrderByWordsExtended);

            Assert.IsTrue(result.SequenceEqual(new string[] { "apple", "zuchini", "blueberry", "cherry", "tamarind" }));
        }
        public string[] SpecialOrderFunction(IEnumerable<string> passList)
        {
            return passList.OrderBy(x => SpecialLength(x.Length)).ToArray();
        }
        public int SpecialLength(int passLength)
        {
            if (passLength % 2 == 0)
            {
                return passLength * 2;
